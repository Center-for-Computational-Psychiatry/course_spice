...
|-------------------------------------------|-------------|--------|
| Class 1 - Foundations of Neuroscience | Introduction to the brain and nervous system, essential for understanding subsequent topics. |[Download Slides](modules/resources/slides/SPICE2024_NeuroPsych_Class1.pdf)|
| Class 2 - Brain Development Across the Lifespan | Examines how the brain changes over time, influencing its functions and potential disorders. | [Download Slides](modules/resources/slides/SPICE2024_NeuroPsych_Class2.pdf)|
| Class 3 - From Classical to Computational Psychiatry | Overview of traditional psychiatry, its strengths and limitations, and the emergence of computational approaches. | [Download Slides](modules/resources/slides/SPICE2024_NeuroPsych_Class3.pdf)|
